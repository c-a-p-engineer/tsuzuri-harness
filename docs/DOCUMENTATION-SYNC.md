...
The repository includes a documentation-sync workflow that checks:
...
- adding, deleting, or renaming a top-level `function/` contract on a PR/push also updates the canonical and Japanese capability inventories.
